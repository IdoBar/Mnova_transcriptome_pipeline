...
output: 
  ...
  #    highlight: pygments
      ...
      code_folding: hide
#      keep_md: true
bibliography: ["style/RNAseq_references.bib", "style/pseudo_counts.bib", "style/trans_assembly_papers.bib", "style/transcriptome_assembly_evaluation.bib", "style/comparative_genomics.bib",
...
pacman::p_load(char = basename(fav_packages), install=FALSE, update=FALSE)
